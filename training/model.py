...
from text_encoder import CLIPTextEncoder, TextPromptLearner


class Video_Text_Prompt_CLIP(nn.Module):
    ...
    def _freeze_visual_except_prompts_time_embed(self):
        for name, param in self.visual.named_parameters():
            if 'summary' in name or 'local' in name  or 'time_embed' in name:
                pass
            else:
